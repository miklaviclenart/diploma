...
se stvar zaplete. Izkaže se, da na vsaki odprti množici obstajajo števila, katerih orbite se med seboj kvalitativno razlikujejo. V tej nalogi bomo torej opazovali rekurzivno zaporedje, dano s predpisom \(z_{n + 1} = e^{z_n}\). Ogledali si ga bomo za različne začetne vrednosti \(z_0\). Elementom takega zaporedja pravimo \emph{orbita} števila \(z_0\). Dokazali bomo naslednji izrek.
...
\noindent Iz izreka nemudoma sledi, da je eksponentna preslikava \emph{kaotična}: pojem, ki ga bomo natančno definirali v poglavju \ref{sec:dis}. Dokaz izreka služi kot dober uvod v \emph{transcendentno dinamiko}, ki jo bomo dodatno obravnavali v zadnjem poglavju. Potrebovali pa bomo tudi nekaj definicij in rezultatov iz kompleksne analize, ki bodo izpeljani v naslednjem poglavju.
%\ref{sec:hipgeom}
