...
\begin{dokaz}
    ...
    %     \caption[Geometrijsko delovanje kompleksne eksponentne preslikave]{Geometrijsko delovanje kompleksne eksponentne preslikave. Ilustracija iz knjige TODO}
    ...
    % \begin{figure}%
    %     \centering
    %     \includegraphics[width=.48\textwidth]{Transitivity_1.pdf}
    %     \hfill
    %     \includegraphics[width=.48\textwidth]{Transitivity_2.pdf}
    %     \caption{}
