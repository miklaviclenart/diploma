...
Pokazali bomo, da kompleksna eksponentna preslikava \(f\) ustreza definiciji topološke tranzitivnosti. Po trditvi \ref{prop:tridevet} nato vemo, da ima \(f\) gosto orbito. Dokazali bomo še več, in sicer, da je množica točk z gosto orbito gosta.
...
\begin{dokaz}
    ...
    \begin{figure}[hb]
        ...
        \caption{Ilustracija dokaza trditve \ref{prop:lare_disks}.}
...
\begin{dokaz}
    Ker so ubežne točke goste, obstaja \(z_0 \in I (f) \cap U\). Naj bo \(z_n \coloneq f^n (z_0)\) za \(n \geq 1\) in naj bodo \(D_n \coloneq \Delta (z_n, 2 \pi)\), \(n_0\) in \(\phi_n\) kot v trditvi \ref{prop:small_disks}. Naj bosta \(\rho\) in \(K\) kot v trditvi \ref{prop:lare_disks}. Ker je \(z_0\) ubežna točka, po točki \ref{item:stiri} trditve \ref{prop:small_disks} obstaja \(N_1 \geq n_0\), da je \(\re z_n \geq \rho\) in \(\phi_n (D_n) \subset U\) za vsak \(n \geq N_1\). Naj bo sedaj \(n \geq N_1\). Potem po trditvi \ref{prop:lare_disks} velja
