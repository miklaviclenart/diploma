\section{Kaotičnost kompleksnega eksponentna}
...
Točka \(z \in \CC\) je \emph{ubežna}, če njena orbita divergira k \(\infty\). Množici vseh ubežnih točk \(I (f)\) pravimo \emph{ubežna množica}, torej
...
\begin{dokaz}[Dokaz izreka \ref{thm:escapingdense}]
    ...
    \[\re w_{n_{k - 1}} = \log \, \bigl| w_{n_{k}} \bigr| \qquad \text{in} \qquad \lim_{k \to \infty} \log \, \bigl| w_{n_{k}} \bigr| = \log z_0 < z_0.\]
