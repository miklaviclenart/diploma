...
V tem poglavju dokažemo izrek \ref{thm:orbits}, v vsakem od podpoglavji po eno točko. Dokaz je povzet po članku \cite{Shen_2015}.
...
\begin{dokaz}[Dokaz izreka \ref{thm:escapingdense}]
    Naj bo \(w_0 \in \CC\) in \(w_n = f^n (w_0)\) za \(n \in \NN\). Naj bo \(D \coloneq \Delta (w_0, r)\). Vemo, da je \([0, \infty) \subset I (f)\), zato je dovolj, da dokažemo, da za neki \(n \in \NN\) velja \(f^n (D) \cap I (f) \neq \emptyset\). Dokazujemo s protislovjem, zato predpostavimo, da za vsak \(n \in \NN\) velja \(f^n (D) \cap I (f) = \emptyset\). Torej je
