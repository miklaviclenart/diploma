...
Za holomorfne funkcije, ki fiksirajo izhodišče, velja nasledja lema. Njen dokaz najdemo v knjigi \cite[lema 1]{Globevnik_2010}.
...
za nek \(k \in \ZZ\). Prav tako bi lahko namesto \(\Arg\) izbrali \(\arg\). Da lahko definiramo inverz, moramo domeno omejiti. Naj bo \(\theta \in \RR\). Potem je
...
\begin{izrek}[Pick] \label{thm:pick}
    Naj bosta \(U, V \subsetneq \CC\) enostavno povezani območji in \(f \colon U \to V\) holomorfna preslikava. Potem na \(U\) obstaja enolično določen hiperbolični ločni element \(\rho_U\), da veljo naslednje izjave.
    \begin{enumerate}
...
\begin{dokaz}
    ...
    Naj bo \(\varphi_4 \colon \CC \setminus (- \infty, 0] \to \HH\); \(z \mapsto \sqrt{z}\). Ta funkcija je biholomorfna, če se omejimo na rešitev \(r e^{i \theta} \mapsto \sqrt{r} e^{i \theta / 2}\) za \(\theta \in (- \pi, \pi)\). Potem je
