...
\begin{lema}[Schwarz] \label{lem:schwarz}
    ...
    \begin{enumerate}
        ...
        \item Obstaja \(\theta \in \RR\), da za vsak \(z\) velja \(f (z) = e^{i \theta} z\) in \(|f' (0)| = |e^{i \theta}| = 1\).
    \end{enumerate}
\end{lema}
...
Funkcija \(f \colon U \to U'\) je \emph{biholomorfna}, če je bijektivna, holomorfna in ima holomorfen inverz \(f^{-1} \colon U' \to U\). Če je \(D\) območje in \(f \colon D \to D'\) bijektivna in holomorfna, vemo, da je biholomorfna (glej \cite[izrek 77]{Globevnik_2010}). Območje je \emph{enostavno povezano}, če je ali enako \(\CC\) ali homeomorfno enotskemu disku. Topološko definicijo nam s kompleksno lastnostjo poveže naslednji znamenit izrek.
...
\begin{itemize}
    ...
    \item Če točka \(z\) potuje proti levi s konstantno hitrostjo, točka \(w\) potuje proti izhodišču s pojemajočo hitrostjo. Obratno, če \(z\) potuje proti desni, potem \(w\) potuje stran od izhodišča s pospešeno hitrostjo.
